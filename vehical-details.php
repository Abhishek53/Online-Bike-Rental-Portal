...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(VehicleId,user_email,FromDate,ToDate,days,Status) VALUES(:vhid,:user_email,:fromdate,:todate,:days,:status)";
...
<section id="listing_img_slider">
  <br>
  <div align="center" style="border-style: solid;"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" width="900" height="560"></div>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="user-login.php" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
